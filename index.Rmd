---
title: "timber! axecute your logs"
...
[Using Addin|
  ...
  Can update possible approved/unapproved
]

[Run Script from another Script|
  Set up script to one file
  Set up script for batch run
  Will axecute one or multiple scripts
] 
...
[R Script is Ready to go] -> [Run Script from another Script]
[Using Addin] -> [Inspect log File]
[Run Script from another Script] -> [Inspect log File]
]",
width = 1000,
height = 500
)
